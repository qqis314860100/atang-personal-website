    ...
    <div className="fixed max-h-full inset-0 bg-black/50 backdrop-blur-sm  flex items-center justify-center z-50">
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-white">错误详情</h3>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-gray-400">错误类型</p>
              <p className="text-white font-medium">{error.error_type}</p>
            </div>
            <div>
              <p className="text-sm text-gray-400">严重程度</p>
              <Badge
            ...
            <div>
              <p className="text-sm text-gray-400">发生页面</p>
              <p className="text-white font-medium">{error.page || '未知'}</p>
            </div>
            <div>
              <p className="text-sm text-gray-400">发生时间</p>
          ...
          <div>
            <p className="text-sm text-gray-400 mb-2">错误信息</p>
          ...
          {error.stack_trace && (
            <div>
              <p className="text-sm text-gray-400 mb-2">堆栈跟踪</p>
              <div className="bg-gray-800 rounded-lg p-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-gray-400">用户代理</p>
              <p className="text-white text-xs break-all">
                {error.user_agent || '未知'}
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-400">IP地址</p>
